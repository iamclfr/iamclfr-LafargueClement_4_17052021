                    ...
                    localStorage.setItem('totalPrice', JSON.stringify(formatCurrency(totalPrice)))
                     ...
                     document.querySelectorAll('.product-cart-trash i').forEach(item => {
                        item.addEventListener('click', event => {
                            ...
                            let cartToTrash = document.querySelector('.product-cart-trash').id
                            console.log(cartToTrash)
                
                            if (cartContent[cartToTrash]) {
                                localStorage.removeItem(cartContent[cartToTrash])
                            }
                        })
                        })
